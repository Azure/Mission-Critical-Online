...
##################
# Ping the GameService API
# We are using the leaderboard/?limit=1 API, since that is one of the few APIs that does not require authentication
# Even if there has been no leaderboard being generated yet, the API will still return a 200 response
