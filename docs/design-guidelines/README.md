# How to Use the AlwaysOn Design Framework
...
At the heart of an AlwaysOn target architecture definition lies a critical design path, comprised of 5 foundational [design principles](../design-guidelines/Principles.md) and 8 [fundamental design areas](../design-guidelines/Design-Areas.md) with heavily interrelated and dependent design decisions.
...
[![Always On Application](/docs/media/AlwaysOn-ReliabilityTiers.png "AlwaysOn Reliability Tiers")](./README.md)
...
[![AlwaysOn SLO availability targets](/docs/media/AlwaysOn-SLO.gif "AlwaysOn SLO Availability Targets")](./README.md)
