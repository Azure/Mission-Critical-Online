...
[![AlwaysOn-Design-Principles](/docs/media/AlwaysOn-Design-Principles-2.png "AlwaysOn Design Principles")](./Principles.md)
...
- **Landing Zone alignment** - Deployable within an [Azure Landing Zone](https://docs.microsoft.com/azure/cloud-adoption-framework/ready/landing-zone/) and aligned to the [Enterprise Scale](https://docs.microsoft.com/azure/cloud-adoption-framework/ready/enterprise-scale/architecture) design methodology, but also fully functional and  deployable in a bare environment outside of a Landing Zone.
