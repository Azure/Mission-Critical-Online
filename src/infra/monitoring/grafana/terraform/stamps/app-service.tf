...
resource "azurerm_linux_web_app" "appservice" {
  ...
  app_settings = {
    ...
    "GF_DATABASE_HOST"     = "${each.key == "primary" ? azurerm_postgresql_server.pgprimary.name : azurerm_postgresql_server.pgreplica.name}.privatelink.postgres.database.azure.com" #.postgres.database.azure.com"
